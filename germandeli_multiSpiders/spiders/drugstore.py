...
class DrugstoreSpider(scrapy.Spider):
    name = "drugstore"
    allowed_domains = ["germandeli.com"]
    start_urls = ['http://germandeli.com']
    custom_settings = {'FILES_STORE': '/home/hung/Projects/germandeli_multiSpiders/output/drugstore'}
    ...
    def parse_product(self, response):#need to use the spash for scraping the ingredients
        ...
        yield DrugstoreSpider(name = name, price = price, description = description, ingredients = ingredients, image_url =[image_url])
